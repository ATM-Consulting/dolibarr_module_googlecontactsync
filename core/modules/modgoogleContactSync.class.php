...
/**
 * 	\defgroup   googlecontactsync     Module googleContactSync
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/googlecontactsync/core/modules directory.
 *  \file       htdocs/googlecontactsync/core/modules/modgoogleContactSync.class.php
 *  \ingroup    googlecontactsync
 *  \brief      Description and activation file for module googleContactSync
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module googleContactSync
 */
class modgoogleContactSync extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->rights_class = 'googlecontactsync';
		...
		$this->description = "Description of module googleContactSync";
		...
		$this->picto='googlecontactsync@googlecontactsync';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /googlecontactsync/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /googlecontactsync/core/modules/barcode)
		// for specific css file (eg: /googlecontactsync/css/googlecontactsync.css.php)
		...
		//							'css' => array('/googlecontactsync/css/googlecontactsync.css.php'),	// Set this to relative path of css file if module has its own css file
		...
		// Example: this->dirs = array("/googlecontactsync/temp");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into googlecontactsync/admin directory, to use to setup module.
		$this->config_page_url = array("googlecontactsync_setup.php@googlecontactsync");
		...
		$this->langfiles = array("googlecontactsync@googlecontactsync");
        ...
        */
		...
		//							'titre'=>'googleContactSync top menu',
		//							'mainmenu'=>'googlecontactsync',
		//							'leftmenu'=>'googlecontactsync',
		...
		//							'titre'=>'googleContactSync left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'googlecontactsync',
	...
	function init($options='')
	{
		...
		dol_include_once('/googlecontactsync/script/create-maj-base.php');
